...
function preload() {
  ...
  //Mouse hovering images
  start1Mouse = loadImage("images/start1.png");
  infoMouse = loadImage("images/info1.png");
  ok = loadImage("images/ok.png");
  okMouse = loadImage("images/ok1.png");
  creditsMouse = loadImage("images/credits1.png");
...
function setup() {
  ...
  creditsButton = createSprite(200, 500);
  creditsButton.addImage("1", credits);
  creditsButton.addImage("2", creditsMouse);
  ...
  creditsSlide = createSprite(450, 300);
  creditsSlide.addImage(creditsSlideImg);
  creditsSlide.visible = false;
  creditsSlide.scale = 0.7;

  closeButton = createSprite(850, 130);
  ...
  playAgain1 = createSprite(600, 390);
  playAgain1.addImage(playAgain);
  playAgain1.visible = false;
  playAgain1.scale = 0.4

  exit = createSprite(350, 390);
  exit.addImage(Exit);
  exit.scale = 0.4;
  exit.visible = false;
...
function draw() {
  ...
  if (gameState === 0) {
    ...
    if (mouseIsOver(creditsButton)) {
      creditsButton.changeImage("2", creditsMouse);
    } else {
      creditsButton.changeImage("1", credits);
    }
    ...
    if (mousePressedOver(creditsButton)) {
      creditsSlide.visible = true;
      closeButton.visible = true;
    }
